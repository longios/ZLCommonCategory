...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ZuJianHuaTest2.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/lq2/ZuJianHuaTest2'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'lq2' => 'wzl930623@163.com' }
  s.source           = { :git => 'https://github.com/lq2/ZuJianHuaTest2.git', :tag => s.version.to_s }
